...
uint8 tft180_x_max = 160;
uint8 tft180_y_max = 128;
...
// @param       dat             需要显示的颜色
// @return      void
// Sample usage:                tft180_drawpoint(0,0,RBB565_RED);  //坐标0,0画一个红色的点
//-------------------------------------------------------------------------------------------------------------------
...
// @return      void
// Sample usage:                tft180_showuint32(0,0,x,3);                     // x 可以为 int32 uint16 int16 uint8 int8 类型
...
// @param       num             需要显示的位数 最高10位  不包含正负号
// @return      void
// Sample usage:                tft180_show_uint32(0,0,x,3);                     // x 可以为 int32 uint16 int16 uint8 int8 类型
// note:                        负数会显示一个 ‘-’号   正数显示一个空格
//-------------------------------------------------------------------------------------------------------------------
...
// @return      void
// Sample usage:                tft180_show_rgb565_image(0,0,camera_buffer_addr,SCCB8660_W,SCCB8660_H,SCCB8660_W,SCCB8660_H,1);
//-------------------------------------------------------------------------------------------------------------------
