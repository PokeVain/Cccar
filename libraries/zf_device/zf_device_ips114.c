...
// @param       dat             需要显示的颜色
// @return      void
// Sample usage:                ips114_drawpoint(0,0,RBB565_RED);  //坐标0,0画一个红色的点
//-------------------------------------------------------------------------------------------------------------------
...
// @param       num             需要显示的位数 最高10位  不包含正负号
// @return      void
// Sample usage:                ips114_show_uint32(0,0,x,3);                    // x 可以为 int32 uint16 int16 uint8 int8 类型
// note:                        负数会显示一个 ‘-’号   正数显示一个空格
//-------------------------------------------------------------------------------------------------------------------
...
// @param       color           显示颜色
// @return      void
// Sample usage:                ips114_show_chinese(0,0,16,chinese_test[0],4,RBB565_RED);//显示font文件里面的 示例
